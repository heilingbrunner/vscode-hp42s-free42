  ...
  private static arr_rawMap = [
...

    {
      ...
      value: [
        ...
        { regex: /F2 ED ([89A-E][0-9A-F])/, len: 3, rpn: 'LSTO IND rr', params: 'reg-128' },
        { regex: /F2 ED F([0-4])/, len: 3, rpn: 'LSTO IND ST `stk`', params: 'stk' },
        ...
        { regex: /F([1-9A-F]) C7/, len: 2, rpn: 'LSTO `nam`', params: 'naml-1' },
        ...
        { regex: /F([1-9A-F]) CF/, len: 2, rpn: 'LSTO IND `nam`', params: 'naml-1' },
