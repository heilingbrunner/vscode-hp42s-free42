...
export class Encoder42 {
  ...
  private static getLanguageIdFromCode(
    ...
    if (
      ...
      // ACCEL|ADATE|ANUM|ATIME24|ATIME|BRESET|BSIGNED|BWRAP|CLK12|CLK24|DATE|DATE+|DDAYS|DMY|DOW|FUNC|GETKEY1|HEADING|LOCAT|LSTO .+|MDY|MVARCAT|NOP|RCLFLAG|RTNERR|RTNNO|RTNYES|STOFLAG|TIME|X<>F|YMD
      rawLine.token &&
      rawLine.token.match(
        /(ACCEL|ADATE|ANUM|ATIME24|ATIME|BRESET|BSIGNED|BWRAP|CLK12|CLK24|DATE|DATE+|DDAYS|DMY|DOW|FUNC|GETKEY1|HEADING|LOCAT|LSTO .+|MDY|MVARCAT|NOP|RCLFLAG|RTNERR|RTNNO|RTNYES|STOFLAG|TIME|X<>F|YMD)/
      )
